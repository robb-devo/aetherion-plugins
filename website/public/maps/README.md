...
| `amethyst-mines.svg` | Amethyst Mines, The Veins |
...
2. Replace the files **or** drop `eldervale.webp` / `amethyst-mines.webp` / `harbour.webp` here and point `image` in `src/content.js` at the new names.
