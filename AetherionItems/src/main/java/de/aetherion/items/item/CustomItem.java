    ...
    public ItemStack createAshenKatana() {
        ...
        if (meta != null) {
            ...
            meta.setLore(createLore(List.of(
                    "§7✦ §6LEGENDARY",
                    "",
                    "§7⚔ Damage: §f+" + String.format(java.util.Locale.US, "%.2f", stats.getDamage()),
                    "§7⚔ Attack Spread: §f+" + String.format(java.util.Locale.US, "%.2f", stats.getAttackSpread()),
                    "§7✧ Crit Chance: §f+" + String.format(java.util.Locale.US, "%.2f", stats.getCritChance()) + "%",
                    "§7✧ Crit Damage: §f+" + String.format(java.util.Locale.US, "%.2f", stats.getCritDamage()) + "%",
                    "",
                    "§dOne draw. The grove finishes the sentence.",
                    "",
                    "§d✦ Falling Blossoms",
                    "§7Right-click: a clean dash, a short",
                    "§7cherry-leaf hover, then a slam.",
