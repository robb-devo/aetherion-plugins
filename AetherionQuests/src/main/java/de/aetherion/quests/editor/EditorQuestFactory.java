...
/**
 * Builds editor-created quests on the live {@link Quest} model.
 * Talk-to-this-NPC by default; gather + rewards are opt-in.
 */
public final class EditorQuestFactory {

    public static final String SERVICE = "editor";

    private EditorQuestFactory() {
    }

    public static boolean isEditorQuest(Quest quest) {
        return quest != null && SERVICE.equalsIgnoreCase(quest.getServiceId());
    }
    ...
    public static String uniqueId(String title, Set<String> taken) {
        ...
        return base + "_" + Integer.toHexString(title == null ? 0 : title.hashCode() & 0xffff);
    }
    ...
    public static boolean isCurrencyReward(String name) {
        ...
        return key.equalsIgnoreCase("Coins")
                ...
                || key.equalsIgnoreCase("Aetherion XP")
                || key.equalsIgnoreCase("Account XP");
    }
